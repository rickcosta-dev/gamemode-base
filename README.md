...
Este projeto está sob a licença MIT. Consulte o arquivo [LICENSE](https://github.com/rickcosta-dev/gamemode-base?tab=Apache-2.0-1-ov-file) para mais detalhes.
